    ...
    function updateSitecheckerMessage() {
        setTimeout(() => {
            ...
            if (officialUrls.includes(pageUrl)) {
                ...
                messageElement.innerHTML = `This link <b>(${pageUrl})</b> is not an official Helios Browser link. Use at your own risk, or find a list of official Helios Browser links <a href="https://discord.gg/UzsCdEVKWb" target="_blank" class="sitechecker-link">here</a>.`;
            }
...
function createCenterSitechecker() {
        ...
        if (!centerSitecheckerContainer) {
            ...
            centerSitecheckerContainer.innerHTML = `
                ...
                <p id="sitechecker-center-text">Hey there! N3xtT1me speaking! I'm proud to announce the v.1 of GOMROM Browser. This is a beta version, if their is any problems, dm me. Thank you for using GOMROM Browser. Credit to my boss, kozyrex for uhh giving me this opportunuity?</p>
                <div class="sitechecker-button-container">
                    <button class="sitechecker-close">Use the GB Proxy</button>
...
<div class="theme-preview" onclick="activatePreview(this)">
  ...
  <p class="theme-name"><i>Default Dark</i> by N3xtT1me</p>
</div>
